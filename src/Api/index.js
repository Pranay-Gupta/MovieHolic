...
export const getUpComing = async (page) => {
    try {
        const {data} = await axios.get(`${URL}/movie/upcoming?api_key=${KEY}&page=${page}`)
        return data
    } catch (error) {
        console.log(error);
    }
...
export const getTopRated = async(type,page)=>{
    try {
        const {data} = await axios.get(`${URL}/${type}/top_rated?api_key=${KEY}&page=${page}`)
        return data;
    } catch (error) {
        console.log(error);
    }
...
export const getGenres = async(type)=>{
    try {
        const {data} = await axios.get(`${URL}/genre/${type}/list?api_key=${KEY}`)
        return data.genres;
    } catch (error) {
        console.log(error);
    }
...
export const getMovies= async(genreId,page)=>{
    try {
        const {data} = await axios.get(`${URL}/discover/movie?api_key=${KEY}&page=${page}&with_genres=${genreId}`)
        return data;
    } catch (error) {
        console.log(error);
    }
...
export const getTrailerID= async(id,type)=>{
    try {
        const {data} = await axios.get(`${URL}/${type}/${id}/videos?api_key=${KEY}`)
...
export const getRecommended = async(id,type,page)=>{
    try {
       const{data} = await axios.get(`${URL}/${type}/${id}/recommendations?api_key=${KEY}&page=${page}`)
        return data;
    } catch (error) {
        console.log(error);
    }
...
export const getCast = async(id,type)=>{
    try {
        const {data} = await axios.get(`${URL}/${type}/${id}/credits?api_key=${KEY}`)
        return data.cast;
    } catch (error) {
        console.log(error);
    }
